...
| **Website repo** | `C:\Users\HP\bari` | Next.js app, components, routes, the frontend JSON the site consumes, lint/build |

- Scoring research, BSIP outputs, CE reports, category rollout → **`C:\Bari`**.
- The scoring engine and pipelines live under `C:\Bari\03_operations\`. The website consumes only the **generated JSON**, copied into `C:\Users\HP\bari\src\data\comparisons\`.
