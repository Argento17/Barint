...
| Website | `C:\Users\HP\bari` | Live UI review and rendered site — confirm directory before reviewing built pages |

**Rule:** Design specs and frontend governance docs → `C:\Bari\01_framework\frontend\`. Hand implementation of any approved design to the Frontend Agent in `C:\Users\HP\bari`. Never edit website source directly.
