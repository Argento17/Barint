...
**Status:** FROZEN â€” Skill Architecture v1
**Frozen:** 2026-05-31
...
|---|---|---|
| **Core** | `B1` bari-category-factory | Pipeline gating â€” Product Agent controls category launch decisions at each BSIP stage |
...
| **Restricted** | `B1` bari-category-factory | No pipeline execution â€” research feeds Data Agent |
...
**Maps to:** Data Architecture / Category Team (no existing agent skill file â€” defined here)
...
| Tier | Skills | Rationale |
|---|---|---|
| **Core** | `B1` bari-category-factory | Pipeline execution authority â€” runs all 7 stages |
...
| **Restricted** | `B4` bari-frontend-ui | No frontend work â€” generates JSON, hands off to Frontend Agent |
| **Restricted** | `T1` frontend-design | No UI design |
| **Restricted** | `T3` react-best-practices | No frontend implementation |
...
| **Core** | `T4` composition-patterns | Component API design â€” prevents boolean prop accumulation |
...
| **Restricted** | `B1` bari-category-factory | No pipeline execution â€” receives frontend JSON, does not generate it |
...
| Tier | Skills | Rationale |
|---|---|---|
| **Core** | `T1` frontend-design | Bold, intentional aesthetic direction â€” anti-generic-AI design philosophy |
...
| **Restricted** | `B1` bari-category-factory | Does not execute pipeline â€” verifies pipeline outputs |
...
| **Restricted** | `T5` ui-ux-pro-max | No design decisions â€” flags failures, Design Agent resolves |
| **Restricted** | `T11` marketing/copywriting | No marketing |
| **Restricted** | `T12` marketing/marketing-ideas | No marketing |
| **Restricted** | `T13` content-strategy | No content strategy |
| **Restricted** | `T14` marketing/seo-audit | No SEO |
...
**Maps to:** Editorial / Content Team (no existing agent skill file â€” defined here)
...
| **Restricted** | `B2` bari-bsip2-scoring-governance | No scoring rules â€” writes copy that explains scores, does not define them |
...
| **Restricted** | `T7` webapp-testing | No test execution |
| **Restricted** | `T12` marketing/marketing-ideas | No growth strategy â€” Marketing Agent owns this |
| **Restricted** | `T14` marketing/seo-audit | No SEO strategy |
...
**Maps to:** Marketing Team (no existing agent skill file â€” defined here)
**Primary workspace:** `C:\Bari` (marketing strategy docs, campaign briefs, SEO plans)
**Mandate:** Owns marketing strategy, SEO, content marketing, and growth for the Bari platform. Operates outside the product pipeline. Works from approved category launches â€” does not initiate category work.
...
| **Restricted** | `B1` bari-category-factory | No pipeline execution â€” marketing activates after BSIP2 readiness is confirmed |
| **Restricted** | `B2` bari-bsip2-scoring-governance | No scoring |
| **Restricted** | `B3` bari-qa-audit | No QA execution |
| **Restricted** | `B4` bari-frontend-ui | No frontend implementation |
| **Restricted** | `T3` react-best-practices | No frontend implementation |
...
|---|---|---|---|---|---|---|---|---|---|
| `B1` bari-category-factory | Core | â€” | â€” | Core | â€” | â€” | â€” | â€” | â€” |
| `B2` bari-bsip2-scoring-governance | Core | Core | â€” | â€” | â€” | â€” | â€” | â€” | â€” |
| `B3` bari-qa-audit | â€” | â€” | â€” | Supp | â€” | â€” | Core | â€” | â€” |
| `B4` bari-frontend-ui | â€” | â€” | â€” | â€” | Core | Supp | Supp | â€” | â€” |
| `T1` frontend-design | â€” | â€” | â€” | â€” | Supp | Core | â€” | â€” | Supp |
| `T2` web-design-guidelines | â€” | â€” | â€” | â€” | Supp | Core | Supp | â€” | â€” |
| `T3` react-best-practices | â€” | â€” | â€” | â€” | Core | â€” | â€” | â€” | â€” |
| `T4` composition-patterns | â€” | â€” | â€” | â€” | Core | Supp | â€” | â€” | â€” |
| `T5` ui-ux-pro-max | â€” | â€” | â€” | â€” | Opt | Core | â€” | â€” | â€” |
| `T6` find-skills | Opt | Opt | Opt | Opt | Opt | Opt | Opt | Opt | Opt |
| `T7` webapp-testing | â€” | â€” | â€” | â€” | Core | â€” | Core | â€” | â€” |
| `T8` content-research-writer | Supp | Supp | Core | Supp | â€” | â€” | â€” | Core | Supp |
| `T9` file-document-processing | â€” | Supp | Core | Core | â€” | â€” | Supp | Opt | â€” |
| `T10` skill-creator | Opt | Opt | Opt | Opt | Opt | Opt | Opt | Opt | Opt |
| `T11` marketing/copywriting | â€” | â€” | â€” | â€” | â€” | â€” | â€” | Supp | Core |
| `T12` marketing/marketing-ideas | Supp | â€” | â€” | â€” | â€” | â€” | â€” | â€” | Core |
| `T13` content-strategy | Supp | â€” | Supp | â€” | â€” | â€” | â€” | Supp | Core |
| `T14` marketing/seo-audit | â€” | â€” | Supp | â€” | â€” | â€” | â€” | â€” | Core |

**Key:** Core = primary owner, Supp = supporting use, Opt = optional/situational, â€” = not in stack
...
`find-skills` and `skill-creator` are available to all agents at the Optional tier by design â€” they enable gap identification without bypassing the approval process.
