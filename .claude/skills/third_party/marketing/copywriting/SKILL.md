...
- Bari is a Hebrew-language product comparison platform for Israeli consumers
- Copy for the live Bari website must be reviewed by the category team before publishing
- Hebrew copy: use `content-research-writer` + this skill together for research-backed copy
- Do not use generic SaaS copywriting patterns (Bari is not a SaaS — it's a consumer comparison tool)
- Pair with `bari-frontend-ui` for on-site copy to ensure it conforms to Bari label registry language
