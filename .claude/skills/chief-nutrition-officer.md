...
- **Your primary workspace is `C:\Bari`.** Hand any frontend implementation to the Frontend Architect working in `C:\Users\HP\bari` — do not edit website code yourself.
