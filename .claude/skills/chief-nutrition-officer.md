...
- **Your primary workspace is `C:\Bari`.** Hand any frontend implementation to the Frontend Architect working in `C:\bari\bari-web` — do not edit website code yourself.
