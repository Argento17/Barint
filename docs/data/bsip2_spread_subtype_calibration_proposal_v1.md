...
Analysis harness: [`analyze_spread_subtype_calibration.py`](../../99_archive/website_snapshot_salvage_2026-06-01/03_operations/bsip2/proto_v0/src/analyze_spread_subtype_calibration.py) → output `spread_subtype_impact.json`. (Salvaged from the removed website snapshot; see that folder's README before promoting back into live `03_operations/`. TASK-131.)
