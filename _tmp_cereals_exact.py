...
# Exact flags from task387 batch script (lines 8-14)
...
os.environ["BARI_D4_SCORE_V1"] = "on"  # D4 was applied after task387 via surgical patch
...
print(f"Exact task387 flags + D4: {matched}/{len(live_map)} match")
if movers:
    print("Movers:")
