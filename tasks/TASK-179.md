...
- **W2 END CONDITION** — W2 closes when TASK-179X records a gate verdict (PASS or FAIL) and CC verifies the threshold table. **PASS** → CC closes 179X, updates this umbrella, opens W3 sub-tasks. **FAIL** → Product + Nutrition propose a W2.1 remediation cycle (per w2_engagement_gate_spec_v1.md §4) before W3 opens. Either outcome ends W2. TASK-179X is the sole remaining W2 task; all other W2 sub-tasks are CLOSED.
