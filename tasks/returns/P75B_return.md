...
| Field | Value |
|---|---|
| Prompt file | `tasks\prompts\P75b_cookies_router_coverage_fix.md` |
| Model | `cursor/agent-cli` |
| Started | 2026-06-13T17:51:19.218493+00:00 |
| Finished | 2026-06-13T17:55:40.470365+00:00 |
| Exit code | 1 |
...
```
--- STDERR ---
T: Increase limits for faster responses You're out of usage. Switch to Auto, or ask your admin to increase your limit to continue.
```
