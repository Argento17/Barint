...
- **🔵 STILL RUNNING (bg, isolated worktree):** Nutrition — de-anchor DESIGN+MEASURE package (new dormant flag `BARI_REDLABEL_CONTINUOUS_V1`, per-category grade-movement table, Product co-sign, rollout). Tripwire-1 proposal; no scores move without owner sign-off.
