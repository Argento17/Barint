...
- **🔵 DISPATCHED (both bg, isolated):** (1) Nutrition — de-anchor DESIGN+MEASURE package (new dormant flag `BARI_REDLABEL_CONTINUOUS_V1`, per-category grade-movement table, Product co-sign, rollout) in a worktree; (2) Nutrition — TASK-454 triage of the 3 routed citations (NOVA PMID 31122155→30744710; emulsifier DOI→Chassaing 2022 PMID 34774538; fermentation EV-024 DOI unresolved → re-source or quantify tier-downgrade score impact). Read-only; no scores move.
