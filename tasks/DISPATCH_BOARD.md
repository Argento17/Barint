...
- **THE ROAD:** P0-3 + P0-2 in flight → verify returns → Content+QA two-gate on both → owner PRs → P0-4 (TASK-457, milk C10/TASK-429, derived live_manifest) → P0-1 full reconciliation (registry fork + remaining local-only) → P0-5 CI wiring (TASK-453 fix order, unblocked by P0-1) → P0-6 key rotation (owner) + hygiene purge (C2).
