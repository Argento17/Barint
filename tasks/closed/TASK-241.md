...
close_reason: "SUPERSEDED - reconciled 2026-06-11; TASK-360/362 snacks corpus rebuild absorbed the rescue scope; snacks_frontend_v5.json live (asserted). Per ghost triage 2026-07-11 (tasks/reports/ghost_triage_2026-07-11.md); orchestrator mechanically asserted the cited artifacts before closing."
priority: HIGH
...
owner_signoff: "Owner 2026-06-10: rescue the 12 dropped products from Shufersal rather than accept a 25-product shelf. [OFF-scope clause SUPERSEDED — see reconciliation banner below.]"
reconciled_at: 2026-06-11
reconciled_by: TASK-242
---

# TASK-241 — Rescue the 12 basis-error drops from Shufersal

> **REGISTRY RECONCILIATION (2026-06-11, TASK-242).** This task's original framing — "OFF removal
> stays **LOCAL** to salty-snacks (global ban TASK-238 **retracted**)" in the owner_signoff and in
> the §Scope/§Preserve sections — is **SUPERSEDED and no longer authoritative.** That 2026-06-10
> "localize / retract" reconciliation was itself retracted the same day: the owner reconfirmed the
> OFF ban is **PROJECT-WIDE and PERMANENT** (TASK-238 reinstated; encoded as the CLAUDE.md "Hard
> rules"; memory `off_ban_hard_rule`). **The rescue *data work* below stands unchanged and was
> correct** — salty-snacks ships with zero OFF, which now satisfies the project-wide rule rather
> than a salty-only carve-out. Read every "OFF stays local / TASK-238 retracted" phrase below as
> "OFF is banned project-wide; salty complies." No other content of this task changes.
