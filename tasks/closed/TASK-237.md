...
close_reason: "SUPERSEDED - snacks OFF removal executed via the project-wide ban + TASK-360/362 rebuild; snacks_frontend_v5.json is the live artifact (asserted). Per ghost triage 2026-07-11 (tasks/reports/ghost_triage_2026-07-11.md); orchestrator mechanically asserted the cited artifacts before closing."
priority: HIGH
