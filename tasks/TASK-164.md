...
escalation: "OWNER DECISION PENDING — grade A->B reconciliation for shufersal_3268429 requires human sign-off (frozen invariant). Fix task to be opened on approval."
depends_on: []
blocks: []
category_id: bread
summary: >
