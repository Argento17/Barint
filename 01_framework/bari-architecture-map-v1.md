...
build_frontend_dataset.py
  ...
  Output: {category}_frontend_vN.json
     ...
     ▼  MANUAL COPY
     │
C:\bari\bari-web\src\data\comparisons\{category}_frontend_vN.json
     │
     ▼
...
A mirror lives at `C:\bari\bari-web\.claude\skills\` so skills load as slash commands in both repos. The mirror is a copy — edit canonical, then re-copy:
...
**Config:** `C:\bari\bari-web\.mcp.json` (server definition) + `C:\bari\bari-web\.claude\settings.json` (approval)
...
**File:** `C:\bari\bari-web\.claude\bari-qa-validate.js`
...
### Website repo hooks (`C:\bari\bari-web\.claude\`)
...
```
C:\bari\bari-web\.claude\settings.json
...
| `index.ts` (view-models) | `C:\bari\bari-web\src\lib\view-models\` | The contract between scoring and UI |
| `index.ts` (registry) | `C:\bari\bari-web\src\lib\comparisons\registry\` | Category routing table |
| `bari-comparison-tokens.ts` | `C:\bari\bari-web\src\lib\design\` | All visual constants |
