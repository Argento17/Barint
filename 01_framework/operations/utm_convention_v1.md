...
https://bari.digital/hashvaot/hummus?utm_source=whatsapp&utm_medium=social&utm_campaign=hummus-sodium-20260712
```
...
Analytics (the cookieless topline counter) also surfaces UTM parameters in
its dashboard, so one tagged link feeds both layers: campaign attribution in
Vercel for ALL visitors, and full acquisition reporting in GA4 for the
consenting subset.
