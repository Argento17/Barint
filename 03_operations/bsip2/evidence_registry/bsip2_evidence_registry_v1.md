...
```yaml
study_objects:
  - claim: "Live yogurt cultures improve lactose digestion — the β-galactosidase in live cultures hydrolyzes lactose in the gut, reducing lactose maldigestion"
    dose_realistic: true
    population_direct: true
    rob_grade: low
    evidence_tier: B
    source_doi: "10.3945/ajcn.113.073023"
    notes: "Savaiano DA, 'Lactose digestion from yogurt: mechanism and relevance,' Am J Clin Nutr 2014 (PMID 24695892; DOI 10.3945/ajcn.113.073023). Mechanistic review; basis of the EFSA Art.13.1 approved claim on live yogurt cultures and lactose digestion. TIER DOWNGRADED A→B and claim NARROWED to lactose digestion (TASK-454, Nutrition co-sign 2026-07-02): the prior source (10.3390/nu11081781) was a citation error resolving to an unrelated Ramadan-fasting/skin study, and no single tier-A paper covers the original three-mechanism bundle (protein pre-digestion + lactose reduction + SCFA). This study grounds ONLY the lactose-digestion mechanism; the other two mechanisms remain uncited pending a systematic review (flagged to Research Agent, non-blocking). Score impact of this correction: ZERO grade changes — measured across the 9 live SKUs carrying the has_fermentation WFI bonus; worst-case full removal = -0.2 weighted pts, no grade flips (TASK-454). EV-024 itself is a vocabulary/detection fix, not a new scientific claim; the has_fermentation +5 WFI bonus is unchanged."
