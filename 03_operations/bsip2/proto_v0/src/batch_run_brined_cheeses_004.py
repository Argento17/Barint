"""
BSIP1 Enrichment + BSIP2 Scoring — Brined Cheeses (run_brined_004)
...
# run_brined_004 uses the hygiene-cleaned BSIP1 run_002
BSIP1_REUSE_DIR = ROOT / "03_operations" / "bsip1" / "run_brined_cheeses_002" / "output"
BSIP2_OUTPUT    = ROOT / "02_products" / "brined_cheeses" / "bsip2_outputs" / "run_brined_004"
...
def main():
    ...
    log.info("=== BSIP2 Brined Cheeses — %s (RT-1 vocab fix + BSIP1 hygiene) ===", RUN_ID)
    ...
    run_record = {
        "run_id":           RUN_ID,
        "task":             "brined-data-remediation-run004",
        "category_slug":    "brined-cheeses",
        "category_context": "dairy_protein",
        "generated":        ts,
        "engine":           "proto_v0 / score_engine.py — EV-052addendum + EV-053 + EV-054 + EV-055",
        "ev_applied":       ["EV-052_addendum", "EV-053", "EV-054", "EV-055"],
        "flag_config": {
            "BARI_RECAL_P0":             "on",
            "BARI_RECAL_P0_YOGURT_TRIM": "off",
    ...
    print("RT-1 vocab fix + BSIP1 hygiene (run_brined_cheeses_002)")
    print("="*70)
    print()
