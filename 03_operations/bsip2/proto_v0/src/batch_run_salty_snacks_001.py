"""
BSIP2 — Salty snacks batch runner (run_salty_snacks_001, TASK-213).
Engine: BARI_RECAL_P0=on (standard production engine).
Source: BSIP1 run_salty_snacks_001 — merged, deduped corpus from Shufersal + Yohananof + Carrefour.
Output: 02_products/salty_snacks/bsip2_outputs/run_salty_snacks_001/
"""
...
OUTPUT_ROOT  = pathlib.Path(r"C:\Bari\02_products\salty_snacks\bsip2_outputs\run_salty_snacks_001")
