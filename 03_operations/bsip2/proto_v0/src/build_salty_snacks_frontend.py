"""
Build salty_snacks_frontend_v1.json from BSIP2 traces.
TASK-213 — Salty Snacks category launch.
"""
import sys, io, json, pathlib, datetime
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8", errors="replace")

TRACES_DIR = pathlib.Path(r"C:\Bari\02_products\salty_snacks\bsip2_outputs\run_salty_snacks_001\products")
BSIP1_DIR  = pathlib.Path(r"C:\Bari\02_products\salty_snacks\bsip1_outputs")
OUT_PATH   = pathlib.Path(r"C:\Bari\02_products\salty_snacks\salty_snacks_frontend_v1.json")
OUT_WEB    = pathlib.Path(r"C:\bari\bari-web\src\data\comparisons\salty_snacks_frontend_v1.json")
...
def build_insight_line(trace, b1) -> str:
    ...
    energy = signals.get("energy_kcal")
