"""
BSIP2 — Yohananof Yogurt batch runner (run_yogurt_yohananof_001, TASK-210 Phase B).
Scores ONLY the new Yohananof yogurt products (not re-scoring Shufersal baseline).
Engine: same as run_yogurt_004 (proto_v0, BARI_RECAL_P0=on).
Source: BSIP1 run_yogurt_yohananof_001 (il_prices + OFF candidate panels).
Output: 02_products/yogurt_system/bsip2_outputs/run_yogurt_yohananof_001/
"""
...
BSIP1_SOURCE = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_yogurt_yohananof_001\output")
OUTPUT_ROOT  = pathlib.Path(r"C:\Bari\02_products\yogurt_system\bsip2_outputs\run_yogurt_yohananof_001")
...
def run_batch():
    ...
    log.info("=== BSIP2 Yohananof Yogurt — %s (BARI_RECAL_P0=%s) ===", RUN_ID, flag)
