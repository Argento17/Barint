"""
BSIP2 Prototype v0 — Cottage / White Cheese Batch Runner (run_cheese_002, post TASK-145 router cream-cheese anchor)
...
Output: 02_products/cheese_spreads/bsip2_outputs/run_cheese_002/
"""
import sys
import json
import pathlib
...
OUTPUT_ROOT  = pathlib.Path(r"C:\Bari\02_products\cheese_spreads\bsip2_outputs\run_cheese_002")
