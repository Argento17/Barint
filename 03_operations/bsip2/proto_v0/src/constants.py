...
HC_DAIRY_SATFAT_C_CEILING_VALUE = 67.0    # HC-2: C-ceiling cap value (top of B/C boundary; cumulative with HC-3)
HC_DAIRY_SATFAT_NA_CAP_600_THRESHOLD = 600.0  # HC-3: sodium >= 600 → na_cap (TASK-412 RT-4 Option B: raised to 67 = HC-2 ceiling)
HC_DAIRY_SATFAT_NA_CAP_600_VALUE = 67.0        # HC-3 RT-4 fix (TASK-412): was 63.0; raised to 67.0 = HC_DAIRY_SATFAT_C_CEILING_VALUE
                                                # Rationale: HC-3 at 63 < HC-2 at 67 violated monotonicity — a 620mg product was
                                                # capped tighter than a 710mg product (adding sodium raised the ceiling, EV-104 defect).
                                                # Option B: remove HC-3 as a distinct tier; HC-2 now governs the whole sodium>=600
                                                # range; within-band differentiation comes from SODIUM_LOAD_GENERAL_GRAD penalty.
HC_DAIRY_SATFAT_G4_KCAL = 380.0           # G4: kcal >= 380 → calorie backstop at 67
HC_DAIRY_SATFAT_G4_BACKSTOP = 67.0        # G4: calorie-dense backstop cap value
