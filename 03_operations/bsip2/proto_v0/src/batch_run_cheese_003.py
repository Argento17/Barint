"""
BSIP2 Prototype v0 — Cottage / White Cheese Batch Runner (run_cheese_003, post TASK-145 router cream-cheese anchor)
Source: Shufersal real scrape -> BSIP1 run_cheese_003 (4 sub-pools + cheese governance constructs).
...
Output: 02_products/cheese_spreads/bsip2_outputs/run_cheese_003/
"""
import sys
import json
import pathlib
...
OUTPUT_ROOT  = pathlib.Path(r"C:\Bari\02_products\cheese_spreads\bsip2_outputs\run_cheese_003")
...
def _write_summary(traces, errors, misroutes, products):
    ...
    summary = {
        ...
        "source": "Shufersal real scrape -> BSIP1 run_cheese_003",
