# BSIP2 batch -- Cookies-near-coffee (run_cookies_002) / TASK-275/P75
...
BSIP2_OUTPUT= ROOT/"02_products"/"cookies_coffee"/"bsip2_outputs"/"run_cookies_002"
RUN_ID = "run_cookies_002"
...
def main():
    ...
    run_record = {
        "run_id":RUN_ID,"task":"TASK-275_P68","category_slug":"cookies-coffee",
