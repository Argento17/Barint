"""
BSIP2 Prototype v0 — Yogurt Batch Runner (run_yogurt_004)
Source: REAL Israeli yogurt SKUs from SHUFERSAL product pages (BSIP0 run_yogurt_004)
...
Output: 02_products/yogurt_system/bsip2_outputs/run_yogurt_004/
"""
...
BSIP1_SOURCE = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_yogurt_004\output")
OUTPUT_ROOT  = pathlib.Path(r"C:\Bari\02_products\yogurt_system\bsip2_outputs\run_yogurt_004")
