"""
BSIP2 Prototype v0 — Cottage / White Cheese Batch Runner (run_cheese_004).

TASK-169B (P1 promotion). Same corpus as run_cheese_003 (Shufersal real scrape ->
BSIP1 run_cheese_003), but scored with BARI_RECAL_P0=ON (the owner-approved P0
recalibration: R1 category-relative protein, R2 fiber-N/A for dairy, R3 leanness,
R4 NOVA flavored-variant guard, R5 graded sat-fat, R6 veg-spread fit, R7 culture gate).

Writes a NEW run dir — does NOT overwrite the published run_cheese_003.
Output: 02_products/cheese_spreads/bsip2_outputs/run_cheese_004/
"""
import os
# Promote the P0 recalibration for THIS run only (env flag; default OFF elsewhere).
...
BSIP1_SOURCE = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_cheese_003\output")
OUTPUT_ROOT  = pathlib.Path(r"C:\Bari\02_products\cheese_spreads\bsip2_outputs\run_cheese_004")
...
def run_batch():
    log.info("=== BSIP2 Cottage/White Cheese — %s (engine 0.4.1, BARI_RECAL_P0=%s) ===",
...
def _write_summary(traces, errors, misroutes, products):
    ...
    summary = {
        ...
        "source": "Shufersal real scrape -> BSIP1 run_cheese_003 (same corpus as run_cheese_003)",
        "governance": "TASK-169 P0 recalibration (R1-R7), v1.1; EV-030/031/032/033 + EV-027/EV-024-026 ext",
        "processed": n,
        ...
        "grade_A_S_landed": a_ceiling_landed,
