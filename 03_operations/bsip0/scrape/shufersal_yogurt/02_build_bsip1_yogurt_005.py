"""
BSIP1 Builder — Yogurt (run_yogurt_005) from Shufersal BSIP0 raw.

This is a thin wrapper over the run_yogurt_004 builder logic, redirected to
run_yogurt_005 paths so the existing run_yogurt_004 output is preserved intact.

Reads:  C:\\Bari\\02_products\\yogurt_system\\bsip0\\yogurt_bsip0_raw_*.json (latest)
Writes: C:\\Bari\\03_operations\\bsip1\\run_yogurt_005\\output\\bsip1_*.json
        + curation_report.json

Run context: run_yogurt_005 / 2026-06-11
  - Full re-acquisition from Shufersal (Option A per owner approval).
...
OUT_DIR = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_yogurt_005\output")
    ...
    for raw in raws:
        ...
        record = {
            ...
            "ingredients_raw_provenance": {
                ...
                "populated_at": "bsip1_build_yogurt_005",
                "missing": not bool(ingr_text),
                "note": "Scraped from Shufersal product page (run_yogurt_005, 2026-06-11). 0 OFF.",
            },
            "allergens_contains": [],
