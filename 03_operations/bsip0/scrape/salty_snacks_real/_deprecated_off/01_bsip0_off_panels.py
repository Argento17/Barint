...
# This scraper acquired OFF nutrition panels and is therefore DISABLED. Do not re-enable
# without a written owner policy. Nutrition/ingredients come ONLY from the direct product
# scrape; NULL/'data could not be retrieved' is the only fallback.
raise RuntimeError(
    "OFF is banned (TASK-238): 01_bsip0_off_panels.py acquired Open Food Facts panels and "
    "is disabled. Use a direct retailer/product scrape for nutrition; never OFF."
)
