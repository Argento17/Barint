...
raise RuntimeError(
    "OFF is banned (TASK-238): fix_beet_cracker_trans.py corrects an Open Food Facts panel "
    "and is disabled. OFF-derived nutrition is NULLed by the TASK-238 remediation."
)
