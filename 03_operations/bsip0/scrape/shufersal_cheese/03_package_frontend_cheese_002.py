...
TRACES = glob.glob(r"C:\Bari\02_products\cheese_spreads\bsip2_outputs\run_cheese_002\products\**\bsip2_trace.json", recursive=True)
BSIP1  = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_cheese_001\output")
CONSTRUCTS = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_cheese_001\cheese_constructs_report.json")
OUT = pathlib.Path(r"C:\Bari\02_products\cheese_spreads\factory_run_002\frontend_package.json")
...
package = {
    ...
    "run_id": "run_cheese_002",
    "generated": datetime.now(timezone.utc).isoformat(),
    "authoritative": False,
    "promoted_to_frontend": False,
    "non_authoritative_reason": "QA misroute gate FAILED (router cream-cheese anchor LANDED via TASK-145/EV-025 — misroute now 1.8% (<5% gate PASS), insufficient 0. Remains NON-AUTHORITATIVE only because Nutrition/Product grade-publication sign-off is pending (incl. confirming the 6 A-ceiling-withheld macro-A white cheeses). Cream pool now routes + scores correctly under dairy_protein.",
    "rtl": True,
    "language": "he",
