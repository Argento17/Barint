...
OUT_DIR = pathlib.Path(r"C:\Bari\03_operations\bsip1\run_cheese_003\output")
    ...
    for s in staged:
        ...
        record = {
            ...
            "ingredients_raw_provenance": {
                ...
                "populated_at": "bsip1_build_cheese_003",
                "missing": not bool(ingr_text),
                "note": "Scraped from Shufersal product page (run_cheese_003, EV-029 corrected fat)",
            },
            "allergens_contains": [],
