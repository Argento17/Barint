...
def load_approved():
    ...
    if not path.exists():
        raise FileNotFoundError(
            ...
            "Run:\n"
            "python 02_approve_candidates.py"
        )
...
def open_product_modal(page, product):
    ...
    for i in range(1, 121):
        if i % 10 == 0:
            print(f"Still looking for approved product... attempt {i}/120 | {barcode} | {name}")
    ...
    raise RuntimeError(
        f"Could not find approved product after scrolling:\n"
        f"barcode={barcode}\n"
        f"name={name}\n"
        f"query={query}"
    )
...
def main():
    ...
    print("\n==============================")
    print(f"Approved products to scrape: {len(approved)}")
    print("==============================")
    ...
    with sync_playwright() as p:
        ...
        for product in approved:
            ...
            print(f"\nScraping approved product: {barcode} | {name}")
            ...
            try:
                ...
                print(f"Saved folder: {RETAILER_DIR / barcode}")
    ...
    print(f"Saved: {RETAILER_DIR / 'run_report.json'}")
    print("==============================")
