...
export function HomeHero() {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-full max-h-[44rem] bg-gradient-to-b from-emerald-950/20 via-zinc-950/20 to-transparent"
        aria-hidden
      />
      ...
      <div
        className="pointer-events-none absolute -end-24 top-8 -z-10 size-[28rem] rounded-full bg-emerald-400/10 blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -start-16 top-24 -z-10 size-[22rem] rounded-full bg-emerald-950/20 blur-3xl"
        aria-hidden
      />
      <HomeContainer className="py-[4.5rem] md:py-24">
        <div className="mx-auto max-w-5xl text-center">
          <Badge
            variant="outline"
            className="reveal-up mb-7 inline-flex items-center gap-2 rounded-full border-emerald-300/12 bg-white/[0.045] px-4 py-2 text-sm font-semibold text-emerald-100 shadow-sm shadow-black/20 backdrop-blur-sm"
          >
            <BariSignalMark className="size-4" />
            מערכת השוואות מזון מבוססת נתונים
          </Badge>

          <h1 className="reveal-up delay-100 text-balance bg-gradient-to-l from-white via-zinc-200 to-emerald-100 bg-clip-text text-4xl font-extrabold leading-[1.08] tracking-[-0.045em] text-transparent sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
            Bari מנתחת מוצרי מזון
            <br />
            ומזהה את מה שחשוב באמת
          </h1>

          <p className="reveal-up delay-200 mx-auto mt-7 max-w-2xl text-pretty text-lg leading-relaxed text-zinc-400 md:text-xl md:leading-relaxed">
          ...
          <div className="reveal-up delay-300 mt-11 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <Button
              size="lg"
              className="group h-12 w-full rounded-2xl border border-emerald-300/10 bg-white px-8 text-base font-semibold text-zinc-950 shadow-lg shadow-emerald-950/15 transition-[box-shadow,transform,background-color] duration-500 ease-out hover:-translate-y-px hover:bg-emerald-50 hover:shadow-xl hover:shadow-emerald-950/20 sm:w-auto"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-12 w-full rounded-2xl border-emerald-300/12 bg-white/[0.045] px-8 text-base font-semibold text-zinc-100 shadow-sm shadow-black/10 backdrop-blur-sm transition-[background-color,box-shadow,transform] duration-500 ease-out hover:-translate-y-px hover:bg-white/[0.075] hover:shadow-md hover:shadow-emerald-950/15 sm:w-auto"
              asChild
            >
          ...
          <div className="reveal-up delay-300 mx-auto mt-16 flex max-w-3xl flex-wrap items-center justify-center gap-x-9 gap-y-4 text-sm text-zinc-400">
            {heroTrust.map((item) => {
