...
export const milkEditorialIntroParagraphs = [
  ...
  "בבדיקה הראשונה של בארי בתחום החלב ותחליפי החלב, ניתחנו שישה מוצרים פופולריים בישראל: חלב מלא, משקאות סויה, שקדים, אורז ושיבולת שועל, לצד משקה חלבון מועשר. המטרה לא הייתה לבדוק «מה בריא יותר», אלא להבין משהו עמוק יותר: עד כמה המוצר נשאר קרוב למזון המקורי שלו — וכמה שכבות של פירוק, עיבוד, ייצוב והנדסה נוספו בדרך.",
  "התוצאה המעניינת ביותר הייתה דווקא זו שלא מעט צרכנים אולי לא היו מצפים לה: חלב מלא רגיל קיבל את הציון הגבוה ביותר בהשוואה. לא בגלל שהוא «מושלם», ולא בגלל שבארי מעדיף מוצרים מן החי — אלא משום שמבחינה מבנית והרכבית הוא נשאר פשוט יחסית. רשימת רכיבים קצרה, כמעט ללא תוספים, ללא מערכות ייצוב מורכבות, וללא צורך «לבנות מחדש» את המוצר באמצעים תעשייתיים.",
  ...
  "זה לא אומר שמשקה צמחי הוא «רע», וגם לא אומר שחלב הוא «טוב». בארי לא עובד בשחור ולבן. האלגוריתם לא מתגמל אידיאולוגיה, טרנד או קטגוריה — אלא בוחן את המבנה בפועל של המזון. שני מוצרים יכולים להציג כמעט אותו מספר חלבון על האריזה, אבל להגיע אליו בדרכים שונות לחלוטין: אחד דרך מזון יחסית שלם, והשני דרך הרכבה מחדש של רכיבים מבודדים.",
  "אחד הדברים הבולטים ביותר בניתוח היה מושג שבארי מכנה «שלמות מבנית» — עד כמה המזון נשאר קרוב למטריצה המקורית שלו. זהו מימד שכמעט לא קיים כיום בשיח התזונתי הרגיל. רוב הצרכנים רגילים להסתכל על סוכר, חלבון או קלוריות, אבל כמעט אף אחד לא מדבר על עומק הפירוק התעשייתי שהמזון עבר לפני שהגיע למדף.",
  ...
  "בארי מנסה לחשוף בדיוק את האזור הזה — האזור שבין טבלת הערכים לבין המציאות התעשייתית של המזון. לא כדי להגיד לצרכנים מה לקנות, אלא כדי להפוך את המזון עצמו לקריא יותר.",
