...
- **The authoring engine is lane-agnostic** (owner 2026-06-20): Sonnet is NOT the sole/ultimate content lane. Cursor and Grok are equally valid content authors — decompose & pick the best lane per piece. Sonnet-only is retired. (Gemini remains weak at Hebrew editorial — recites grams/E-codes — so prefer it last for content; the binding constraint is the **two-gate sign-off**, not the engine. Supersedes [[content_lane_sonnet_not_gemini]]'s Sonnet-only framing.)
