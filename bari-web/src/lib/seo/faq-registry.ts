...
import yogurtDrinksFaq from "@/data/seo/yogurt_drinks_faq_schema.json";
import yogurtSpoonableFaq from "@/data/seo/yogurt_spoonable_faq_schema.json";
...
const FAQ_BY_KEY: Record<string, Record<string, unknown>> = {
  ...
  yogurt_drinks: yogurtDrinksFaq as Record<string, unknown>,
  yogurt_spoonable: yogurtSpoonableFaq as Record<string, unknown>,
};
