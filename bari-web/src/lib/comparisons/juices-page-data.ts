...
export const juicesPrologueSentences = [
  "בוקר. אתם מושיטים יד לבקבוק המיץ — סחוט, צבעוני, עם תמונת פרי על האריזה.",
  "הבעיה היא שלא תמיד הסיפור שעל האריזה מתאים לסיפור שברשימת הרכיבים.",
  ...
  "מה שגילינו הוא שהפערים בין המוצרים כאן גדולים בצורה שמפתיעה — מרכיב יחיד סחוט טרי ועד בקבוק שבו הפרי הוא הרכיב השלישי אחרי מים וסוכר.",
