...
export const crackersPrologueSentences = [
  ...
  "בדקנו 19 קרקרים מהמדף לפי הרכב הרכיבים והערכים התזונתיים שעל האריזה, והשווינו כל אחד מול השאר — לא מול לחם.",
] as const;
...
export const crackersComparisonMetadata: Metadata = {
  ...
  description:
    "השוואה של 19 קרקרים מהמדף לפי דומיננטיות דגן מלא, אורך רשימת הרכיבים ותרומת סיבים — לא לפי קלוריות. כל קרקר מושווה מול קרקרים אחרים, לא מול לחם.",
};
