...
export const hummusPrologueSentences = [
  ...
  "כל מוצר מקבל ציון על סולם 0–100 ביחס לקטגוריה בלבד: חומוס נמדד מול חומוס בלבד.",
  "בחזית כל מוצר בחרנו להציג את החלבון, במכוון. חומוס הוא מקור החלבון הצמחי המרכזי במדף, וכמות החלבון מסגירה כמה גרגירי חומוס וטחינה יש בממרח באמת, לעומת מים ושמן שמדללים אותו.",
  "חלבון גבוה הוא לרוב הסימן לממרח מלא יותר, וזו רק הכותרת: הציון משקלל גם את רמת העיבוד, את מספר התוספים ואת ההרכב הכולל.",
] as const;
