...
export const saltySnacksMethodologyLines = [
  "בדקנו 47 חטיפים מלוחים ממדף יוחננוף — רכיבים, ערכי תזונה ורמת עיבוד.",
...
export const saltySnacksComparisonMetadata: Metadata = {
  ...
  description:
    "השוואת 47 חטיפים מלוחים מהמדף הישראלי — ציון Bari, רכיבים, ערכי תזונה ורמת עיבוד. מידע, לא המלצה.",
};
