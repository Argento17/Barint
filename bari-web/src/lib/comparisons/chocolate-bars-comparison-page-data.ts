...
export const chocolateBarsHero = {
  ...
  title: "חטיפי השוקולד האלה הם חטיפי ממתק לכל דבר, וכולם יודעים את זה",
} as const;
...
export const chocolateBarsCategoryNote = [
  "כל מוצר במדף הזה מקבל ציון E. זהו ציון מדויק לקטגוריה אחת של ממתקים, וההשוואה היא בתוכה.",
  "כשמוצר מדורג גבוה כאן, המשמעות היא שהוא הכי פחות מהונדס: יש בו רכיב אחד שהוא אוכל ממש, או פחות סוכר, או רשימה קצרה יותר.",
...
export const chocolateBarsMethodologyLines = [
  ...
  "הציון נשען על כמות הסוכר, סוג המילוי, רמת העיבוד ואורך רשימת הרכיבים, מעבר לגודל החטיף.",
