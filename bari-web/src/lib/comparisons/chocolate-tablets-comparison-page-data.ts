...
export const chocolateTabletsCategoryNote = [
  "רק שתי טבלאות במדף הזה מגיעות ל-B, ואחריהן פער של עשר נקודות עד הבאה בתור. שוקולד הוא ממתק צפוף בשומן וסוכר, וגם שתי הטבלאות שמובילות את המדף לא מתחמקות מזה. ה-B הוא הצד הנכון של מדף הממתקים; לא מוצר בריאות.",
