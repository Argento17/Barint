...
export const breadHero = {
  ...
  title: "לחם: הציון קורא את מה שבאמת בפנים",
} as const;
...
export const breadPrologueSentences = [
  ...
  "ההשוואה מתבססת על מה שאפשר לבדוק ברשימת הרכיבים עצמה: ערכי חלבון, סיבים, נתרן ותסיסה מאומתת.",
] as const;
...
export const breadCategoryNote = [
  "הערת קטגוריה — תסיסה ודגן מלא נקראים מהרשימה\n\nהציון מזהה מחמצת, דגן מלא וסיבים לפי מה שמופיע ברשימת הרכיבים בפועל. לחם שכתוב עליו 'מחמצת' או 'מלא' עשוי להישען על שמרים תעשייתיים או על תערובת קמחים, וזה מה שמשתקף בציון.",
...
export const breadMethodologyLines = [
  "ניתוח לחמים מבוסס על נתונים מגלויות שופרסל: מדגם מדף ממוקד, בהיקף חנות בודדת.",
  "לכל מוצר נבחנו הרכב הרכיבים, ערכי חלבון וסיבים, רמת עיבוד ותסיסה מאומתת ברכיבים.",
  "ציון הלחם משקלל מבנה, מקור הדגן ורמת ההנדסה במוצר, מעבר לקלוריות בלבד.",
