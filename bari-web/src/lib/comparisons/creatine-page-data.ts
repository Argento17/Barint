...
// 36 displayed: 23 Israeli shelf + 13 worldwide benchmark.
export const creatineMetadataLine = "23 מוצרים מהמדף הישראלי · 13 מותגי ייחוס עולמיים · יולי 2026";
...
export const creatineIsraeliSectionLabel = "המדף הישראלי — 23 מוצרים";
export const creatineWorldwideSectionLabel = "מותגי ייחוס עולמיים — 13 מוצרים, 5 מדינות";

// ─── Israeli shelf — 23 products (§1.2) ──────────────────────────────────────
...
const creatineIsraeliProductsRaw: BariProductVM[] = [
  // ── honest — meaningful dose (10 products), sorted by price-per-3g ascending ──
  {
    ...
    brand: "NOW Foods",
    imageUrl: "/products/733739020383.webp",
    score: null,
    grade: null,
  ...
  },
  {
    ...
    brand: "ABE",
    imageUrl: "/products/5056555204153.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
  ...
  },
  {
    ...
    brand: "MuscleTech",
    imageUrl: "/products/631656705737.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
  ...
  },
  {
    ...
    brand: "MyProtein",
    imageUrl: "/products/5055534302002.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
  ...
  },
  {
    ...
    name: "אבקת קריאטין",
    brand: "All In",
    imageUrl: "/products/7290019766223.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
      "מונוהידראט", "3.0 גרם", "honest", DOSE_HONESTY_LABEL.honest,
  ...
  },
  {
    ...
    imageUrl: "/products/748927023855.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
      "מונוהידראט", "5.0 גרם", "honest", DOSE_HONESTY_LABEL.honest,
  ...
  },
  {
    ...
    name: "Creatine",
    brand: "Thorne",
    imageUrl: "/products/693749006350.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
      "מונוהידראט", "5.0 גרם", "honest", DOSE_HONESTY_LABEL.honest,
  ...
  },
  {
    ...
    imageUrl: "/products/898220022830.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
  ...
  // ── disclosed, below floor — HCl (2 products), sorted by price-per-3g ascending ──
  {
    ...
    name: "Creatine HCl",
    brand: "Kaged",
    imageUrl: "/products/850045966478.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
  ...
  },
  {
    ...
    name: "Creatine HCl",
    brand: "Con-Cret",
    imageUrl: "/products/682676700646.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
      "HCl", "0.75 גרם", "below_floor", DOSE_HONESTY_LABEL.below_floor,
  ...
  // ── undisclosed dose (4 products): 3 Shufersal grocery + 1 MyProtein tablet ──
  {
    ...
    brand: "Super Effect",
    imageUrl: "/products/7290014386006.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
      "מונוהידראט", "3.1 גרם", "honest", DOSE_HONESTY_LABEL.honest,
      null, "לא נמצאה טענה",
      null
    ),
    insightLine: "המילה קריאטין מופיעה על האריזה, אך אין שום מספר גרם למנה — אי אפשר לחשב מהתווית כמה קריאטין באמת מקבלים.",
    rowVerdict: "מונוהידראט, 3.1 גרם — // TODO owner-description-pass (freeze)",
    confidence: "partial",
    expansion: {
      nutrition: null,
      ingredients: null,
  ...
  },
  {
    ...
    brand: "Super Effect",
    imageUrl: "/products/7290016392005.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
      "מונוהידראט", "3.1 גרם", "honest", DOSE_HONESTY_LABEL.honest,
  ...
  },
  {
    ...
    brand: "Sport GS",
    imageUrl: "/products/7290010081288.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge(
    ...
    insightLine: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: {
      nutrition: null,
      ingredients: null,
      confidenceLabel: "מבוסס על דף המוצר (Nizat) — 3000 מ״ג למנה",
      servingNote: "למנה יומית",
      positiveSignals: [],
      limitingFactors: [],
    },
  ...
  {
    id: "7290122852677",
    name: "מונוהידראט קריאטין",
    brand: "Life",
    imageUrl: "/products/7290122852677.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("מונוהידראט", "3.0 גרם", "honest", DOSE_HONESTY_LABEL.honest, null, "לא נמצאה טענה", "₪0.90 ל-3 גרם"),
    insightLine: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית סופר-פארם", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: [] },
  },
  {
    id: "7290014386013",
    name: "קריאטין מונוהידראט תפוח",
    brand: "Super Effect",
    imageUrl: "/products/7290014386013.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("מונוהידראט", "3.1 גרם", "honest", DOSE_HONESTY_LABEL.honest, null, "לא נמצאה טענה", "₪0.96 ל-3 גרם"),
    insightLine: "מונוהידראט, 3.1 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 3.1 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית סופר-פארם", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: [] },
  },
  {
    id: "7290120937000",
    name: "ALL IN 80 אבקת קריאטין",
    brand: "Life",
    imageUrl: "/products/7290120937000.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("לא צוין", "3.0 גרם", "honest", DOSE_HONESTY_LABEL.honest, null, "לא נמצאה טענה", "₪1.37 ל-3 גרם"),
    insightLine: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית סופר-פארם", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: [] },
  },
  {
    ...
    brand: "Super Effect",
    imageUrl: "/products/7290014386396.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("מונוהידראט", "2.5 גרם", "below_floor", DOSE_HONESTY_LABEL.below_floor, null, "לא נמצאה טענה", "₪0.96 ל-3 גרם"),
    insightLine: "מונוהידראט, 2.5 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 2.5 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית סופר-פארם", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: [] },
  },
  {
    id: "7290122852837",
    name: "ALL IN ענבים 240 אבקת קריאטין",
    brand: "Life",
    imageUrl: null,
    score: null,
    grade: null,
    creatineBadges: mkBadge("לא ניתן לאימות", "לא ניתן לאימות", "undisclosed", DOSE_HONESTY_LABEL.undisclosed, null, "לא נמצאה טענה", null),
    insightLine: "מונוהידראט — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט — // TODO owner-description-pass (freeze)",
    confidence: "partial",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על נתונים חלקיים", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: ["מינון לא מפורט מלא על התווית"] },
  },
  {
    id: "7290001066775",
    name: "קריאטין מונוהידראט 250 גרם",
    brand: "Nutri Care",
    imageUrl: "/products/7290001066775.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("מונוהידראט", "3.0 גרם", "honest", DOSE_HONESTY_LABEL.honest, null, "לא נמצאה טענה", "₪1.08 ל-3 גרם"),
    insightLine: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 3.0 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית Nizat", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: [] },
  },
  {
    id: "7290018534427",
    name: "קריאטין מונוהידרט, כשר בד\"ץ, 500 גרם",
    brand: "Extreme Nutrition",
    imageUrl: "/products/7290018534427.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("מונוהידראט", "2.5 גרם", "below_floor", DOSE_HONESTY_LABEL.below_floor, null, "לא נמצאה טענה", "₪0.57 ל-3 גרם"),
    insightLine: "מונוהידראט, 2.5 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט, 2.5 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית VitamGlobal", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: ["2.5 גרם למנה — מתחת לרצפת הטווח שנחקר (3 גרם)"] },
  },
  {
    id: "810100920517",
    name: "אבקת קריאטין מונוהידראט טבעונית 300 גרם",
    brand: "Sunwarrior",
    imageUrl: "/products/810100920517.webp",
    score: null,
    grade: null,
    creatineBadges: mkBadge("מונוהידראט", "3.0 גרם", "honest", DOSE_HONESTY_LABEL.honest, null, "לא נמצאה טענה", "₪1.20 ל-3 גרם"),
    insightLine: "מונוהידראט טבעוני, 3.0 גרם — // TODO owner-description-pass (freeze)",
    rowVerdict: "מונוהידראט טבעוני, 3.0 גרם — // TODO owner-description-pass (freeze)",
    confidence: "verified",
    expansion: { nutrition: null, ingredients: null, confidenceLabel: "מבוסס על תווית Nizat", servingNote: "למנה יומית", positiveSignals: [], limitingFactors: [] },
  }
];
