...
// §2.3 "מה קריאטין באמת עושה" + §2.4 "המינון האפקטיבי" + §2.5 "צורות" + §2.6 "בטיחות"
// folded into the category note per the magnesiumCategoryNote pattern (methodology +
// evidence tiers + dose-honesty explainer + category caveat, in one multi-paragraph block).
