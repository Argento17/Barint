...
export const cerealsPrologueSentences = [
  ...
  "דגני בוקר מגיעים עם ניחוח בריאות — 'דגנים מלאים', 'עשיר בסיבים', 'ויטמינים ומינרלים' — האריזה עמוסה הבטחות.",
  "מה שגילינו הוא שהסיפור מאחורי ההבטחות משתנה מאוד ממוצר למוצר.",
  "יש כאן מוצרים שעושים את העבודה באמת — רשימה קצרה, דגן מלא אמיתי, חלבון וסיבים שמצדיקים את הציפייה.",
  "ויש מוצרים שלובשים את חולצת 'ארוחת הבוקר' אבל מבחינת הרכבם קרובים יותר לקינוח יבש שמוזגים עליו חלב.",
  "הפערים בין המוצרים כאן גדולים בצורה שמפתיעה. גרנולה ומוזלי מוצגים בעמוד נפרד.",
] as const;
