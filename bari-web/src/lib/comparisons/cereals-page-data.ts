...
export const cerealsPrologueSentences = [
  "בדקנו 26 מוצרי דגני בוקר מהמדף הישראלי בשופרסל.",
  "אף מוצר לא הגיע ל-A — הציון הגבוה ביותר עוצר ב-75/B.",
  "החלוקה: שלושה מוצרים ב-B, תשעה ב-C, 12 ב-D ושניים ב-E.",
  "ארבעה מוצרים מיועדים לילדים; הפער בין הגבוה לנמוך הוא 43 נקודות.",
...
export const cerealsCategoryNote = [
  ...
  "הערת קטגוריה — טענת 'דגנים מלאים' נקראת מהרשימה, לא מהמיתוג\n\nטענת 'דגנים מלאים' מופיעה על 18 מוצרים בעמוד זה, אך לא בכולם סדר הרכיבים תומך בה — לעיתים קמח לבן מופיע לפני הדגן המלא. הציון מבוסס על ההרכב בפועל, לא על הטענה שעל האריזה.",
].join("\n\n");

export const cerealsMethodologyLines = [
  "בדקנו 26 מוצרי דגני בוקר מהמדף בשופרסל — רכיבים, ערכי תזונה ורמת עיבוד, לא רק קלוריות.",
...
export const cerealsComparisonMetadata: Metadata = {
  ...
  description:
    "השוואת 26 מוצרי דגני בוקר מהמדף הישראלי — ציון Bari, רכיבים, ערכי תזונה ורמת עיבוד. מידע, לא המלצה.",
};
