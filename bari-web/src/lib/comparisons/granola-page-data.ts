...
export const granolaHero = {
  ...
  title: "גרנולה ומוזלי: 22 מוצרים, פער של כמעט 40 נקודות",
} as const;
...
export const granolaPrologueSentences = [
  ...
  "בדקנו 22 מוצרים מהמדף הישראלי: אף אחד לא הגיע ל-A. רוב המדף מתקבץ סביב C ו-D.",
  "הפער בין הטוב ביותר (69.7/B) לנמוך ביותר (32.8/E) הוא כמעט 40 נקודות — על אותו מדף, לעיתים תחת שם דומה.",
