...
export const snacksHero = {
  eyebrow: "חטיפי דגנים",
  title: "חטיף דגנים נשמע כמו הבחירה הבריאה במדף; רשימת הרכיבים מספרת סיפור מדויק יותר",
} as const;
...
export const snacksPrologueSentences = [
  ...
  "המדף מחזיק שני קצוות רחוקים: מצד אחד משפחה של חטיפי תמרים עם שניים עד שלושה רכיבים שכולם מזון ואפס סוכר מוסף; מצד שני 'חטיף דגנים' ששוקולד חלב הוא הרכיב הראשון שלו וסירופ גלוקוז מופיע פעמיים בהמשך הרשימה. אותו מדף, אותה הבטחה, וציונים שנעים על פני יותר מ-50 נקודות.",
  "גם החטיף החזק כאן מגיע רק ל-B, כי במדף הזה 'טוב' אומר פחות מהונדס, במובן מצומצם. חטיפי חלבון מהונדסים סביב 25–36 גרם חלבון ל-100 גרם נמדדים בקטגוריה ובעמוד נפרדים.",
] as const;
...
export const snacksCategoryNote = [
  "הערת קטגוריה — 'הכי טוב' כאן הוא B\n\nבמדף חטיפי הדגנים אף מוצר אינו מגיע ל-A. הציון הגבוה בקטגוריה הוא 67/B. זו תיאור מדויק של הקטגוריה: חטיפי דגנים מתוכננים סביב שילוב של דגן מעובד, סוכר ולעיתים שוקולד שמעלה את החיך, והציון משקף זאת.",
  "הערת קטגוריה — חטיפי חלבון נמצאים בעמוד נפרד\n\nהעמוד הזה מציג חטיפי דגנים בלבד. חטיפי חלבון (פרוטאין), מוצרים מהונדסים סביב 25–36 גרם חלבון ל-100 גרם, ממתיקים ותחליפי סוכר, נמדדים בקטגוריה משלהם ומוצגים בעמוד נפרד.",
  "הערת קטגוריה — ההשוואה היא בתוך הקטגוריה בלבד\n\nחטיף נמדד מול חטיפים אחרים בלבד. ציון B כאן אומר 'הטוב יחסית במדף חטיפי הדגנים', ולא שהמוצר שקול לארוחה או לבסיס מזון מלא.",
]
  .join("\n\n");
