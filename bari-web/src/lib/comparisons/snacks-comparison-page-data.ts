...
export const snacksPrologueSentences = [
  ...
  "הם לא. מצד אחד משפחה של חטיפי תמרים עם שניים עד שלושה רכיבים שכולם מזון ואפס סוכר מוסף; מצד שני 'חטיף דגנים' ששוקולד חלב הוא הרכיב הראשון שלו וסירופ גלוקוז מופיע פעמיים בהמשך הרשימה. אותו מדף, אותה הבטחה — וציונים שנעים על פני יותר מ-50 נקודות.",
  "גם החטיף החזק כאן מגיע רק ל-B, כי במדף הזה 'טוב' אומר פחות מהונדס — לא בריא במובן הרחב. חטיפי חלבון מהונדסים סביב 25–36 גרם חלבון ל-100 גרם נמדדים בקטגוריה ובעמוד נפרדים.",
] as const;
