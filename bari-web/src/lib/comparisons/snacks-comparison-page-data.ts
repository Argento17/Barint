...
export const snacksPrologueSentences = [
  ...
  "הם לא. מצד אחד משפחה של חטיפי תמרים עם שניים עד שלושה רכיבים שכולם מזון ואפס סוכר מוסף; מצד שני 'חטיף דגנים' ששוקולד חלב הוא הרכיב הראשון שלו וסירופ גלוקוז השני. אותו מדף, אותה הבטחה — וציונים שנעים על פני יותר מ-50 נקודות.",
