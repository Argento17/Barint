...
// (hummus). Rollback: set NEXT_PUBLIC_GLASSBOX_D5D6=off in the hosting env.
...
// (the D3 processing drilldown line on hummus). ~13 grade moves live.
...
// (2) the inline "פירוט המתודולוגיה" link in the MethodologyFooter on hummus.
