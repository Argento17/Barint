    ...
    >
      <HomeContainer className="py-14 md:py-20">
        ...
        <p className="mt-5 max-w-2xl text-pretty text-lg leading-relaxed text-[#4E5663]">
          הגוף לא סופג את כל המינרל שעל הקופסה. כמה באמת מגיע פנימה תלוי במינון היסודי, בצורה הכימית שנספגת, ובחוזק העדויות לייעוד. המספר הגדול על הקופסה הוא נקודת הפתיחה בלבד, ומשם בארי בודקת את מה שבאמת קובע. לכן בארי מודדת כל תוסף לפי מה שמגיע באמת לגוף — שם נקבע אם הוא שווה את מה שהובטח על הקופסה.
        </p>
