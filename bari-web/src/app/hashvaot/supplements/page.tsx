...
const MAGNESIUM_DESCRIPTION =
  "בדקנו 18 תוספי מגנזיום מהמדף הישראלי. המוצרים הזולים ביותר מציגים הכי הרבה מגנזיום על האריזה — כי הם משתמשים באוקסיד, שהגוף סופג ממנו רק כ-4%. אף מוצר לא הגיע ל-A או B: המדף כולו מתחת למינון שנחקר.";
