...
export default function HashvaotIndexPage() {
  ...
  const frozenVegetablesDescription = "53 ירקות קפואים ממדף שופרסל, מחולקים לפי ארבעה שימושים במטבח — ירק בודד, קטנייה, תערובת ותיבול. בלי ציון ובלי דירוג: בכל קבוצה מתואר מה כל מוצר מביא לשימוש שאתם מתכננים.";
