...
export const metadata: Metadata = {
  ...
  // Secondary: תאריך מסיק שמן זית, PDO שמן זית, מה לחפש בשמן זית, שמן זית השוואה
  ...
  title: "13 מוצרי שמן זית בשופרסל. אפס גילויים על תאריך המסיק. | Bari",
  description:
    "סרקנו את מלאי שמן הזית בשופרסל — 13 מוצרים. אף אחד לא מצהיר על תאריך מסיק. מה \"כתית מעולה\" מבטיח — ומה הוא לא מחויב לגלות.",
  openGraph: blogOpenGraph({
    title: "13 מוצרי שמן זית בשופרסל. אפס גילויים על תאריך המסיק.",
    description:
      "סרקנו את מלאי שמן הזית בשופרסל — 13 מוצרים. אף אחד לא מצהיר על תאריך מסיק. מה \"כתית מעולה\" מבטיח — ומה הוא לא מחויב לגלות.",
    type: "article",
  }),
...
export default function OliveOilBlogPage() {
  return (
    ...
    <BlogArticleSeo
      title={"13 מוצרי שמן זית בשופרסל. אפס גילויים על תאריך המסיק."}
      description={"סרקנו את מלאי שמן הזית בשופרסל — 13 מוצרים. אף אחד לא מצהיר על תאריך מסיק. מה \\"}
