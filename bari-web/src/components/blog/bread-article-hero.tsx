...
export function BreadArticleHero() {
  const { hero, disclaimer } = breadArticle;
      ...
      <HomeContainer className="flex flex-col py-8 md:py-12">
        ...
        <div className="flex max-w-3xl flex-col justify-center text-right">
          ...
          <div className="mt-6 flex flex-wrap gap-8 border-t border-black/6 pt-5">
            <div>
              <p className="text-2xl font-extrabold tracking-tight text-[#111318]">256</p>
              <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-[#7A817C]">
                מוצרים נסרקו
              </p>
            </div>
            <div>
              <p className="text-2xl font-extrabold tracking-tight text-[#111318]">24</p>
              <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-[#7A817C]">
                קיבלו ציון מלא
              </p>
            </div>
            <div>
              <p className="text-2xl font-extrabold tracking-tight text-[#7A9450]">13/24</p>
              <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-[#7A817C]">
                הגיעו ל-A
              </p>
            </div>
            <div>
              <p className="text-2xl font-extrabold tracking-tight text-[#111318]">16 נקודות</p>
              <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-[#7A817C]">
                הפרש — A הגבוה לעומת B הנמוך
              </p>
            </div>
          </div>
