...
export function HummusArticleHero() {
  const { hero, disclaimer } = hummusArticle;
      ...
      <HomeContainer className="flex flex-col py-8 md:py-12">
        ...
        <div className="flex max-w-3xl flex-col justify-center text-right">
          ...
          <div className="mt-6 flex gap-8 border-t border-black/6 pt-5">
            <div>
              <p className="text-2xl font-extrabold tracking-tight text-[#111318]">64</p>
              <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-[#7A817C]">
                מוצרים · מדף שופרסל
              </p>
            </div>
            <div>
              <p className="text-2xl font-extrabold tracking-tight text-[#111318]">88–42</p>
              <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-[#7A817C]">
                טווח ציונים
              </p>
            </div>
