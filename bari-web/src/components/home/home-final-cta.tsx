  ...
  return (
    <section className="relative overflow-hidden bg-[#F7F7F2] py-20 md:py-24">
      <HomeContainer className="relative text-center">
        <p className="mb-4 text-sm font-bold text-[#167A58]">הצעד הבא</p>
        ...
        <div className="mt-10 flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center sm:justify-center sm:gap-5">
          <Button
            size="lg"
            className="h-12 rounded-2xl border border-[#1F8F6A]/10 bg-[#167A58] px-10 text-base font-bold text-[#F7F7F2] shadow-xl shadow-slate-900/10 hover:bg-[#167A58] sm:min-w-44"
            asChild
          >
