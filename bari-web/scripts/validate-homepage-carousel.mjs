...
// 10. Total card count
check("Total cards === 5", cards.length === 5, `got ${cards.length}`);

// 11. No removed card ids present
const removedIds = ["category-report-snacks", "supplement-magnesium-form", "ingredient-cereal-sugar-aliases", "comparison-milk-whole-vs-soy", "comparison-bread-sourdough-vs-cracker", "comparison-hummus-tahini-rich-vs-lean"];
